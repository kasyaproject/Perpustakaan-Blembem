<header class="antialiased">
        ...
        <nav class="bg-white border-gray-200 px-10 max-md:px-2 lg:px-40 py-2.5 dark:bg-gray-800">
            <div class="flex flex-wrap justify-between items-center">
                <div class="flex justify-start items-center px-4">
                    <button id="toggleSidebar" aria-expanded="true" aria-controls="sidebar" class="hidden text-gray-600 rounded cursor-pointer lg:inline hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700">
                    ...
                    <div class="self-center text-2xl max-md:text-lg font-semibold whitespace-nowrap dark:text-white max-sm:hidden">Perpustakaan Digital MIM BLEMBEM</div>
                    </a>
                    {{-- SEARCH FORM --}}
                ...
                <div class="flex items-center lg:order-2">            
                    ...
                    {{-- MENU KATTEGORI --}}
                    <button type="button" data-dropdown-toggle="kategories-dropdown" class="flex items-center px-3 p-2 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
                        <span class="items-center justify-center dark:text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-base mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800 max-lg:hidden">Kategori</span>   
                        <!-- Icon -->
                    ...
                    <!-- Dropdown menu KAEGORIES-->
                    <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600" id="kategories-dropdown">
                        <div class="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            Kategori
                        </div>
                        <?php
                        ...
                        <div class="grid grid-cols-3 gap-4 p-4">                            
                            <a href="{{ route('guest') }}" class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group">
                                <img src="/asset/pelajaran.png" class="mx-auto mb-2 w-7 h-7" alt="pelajaran">
                                <div class="text-sm font-medium text-gray-900 dark:text-white">Semua Buku</div>
                            </a>
                    ...
                    {{-- MENU BUTTON MASUK --}}
                    <a href="/login">
                        <button type="button" class="flex mx-3 items-center text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-sm px-5 py-2 text-center me-2 ">
                            MASUK
                        </button>
                    </a>                
                </div>
