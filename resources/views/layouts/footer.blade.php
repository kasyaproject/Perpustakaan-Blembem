<footer class="bg-white rounded-t-lg mb-[-25px] shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800 antialiased">
    <p class="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
        &copy; 2024 <a href="#" class="hover:underline" target="_blank">********.com</a>. All rights reserved.
    </p>
